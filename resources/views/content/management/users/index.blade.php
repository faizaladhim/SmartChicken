...
@section('title', 'Manage User | SmartChicken')
        ...
        <div class="card">
            <div class="card-body">
                <div class="d-flex justify-content-between">
                    ...
                    <a href="{{ url('management/users/create') }}" class="btn btn-primary">Add Users</a>
                </div>
                        ...
                        @foreach ($users as $item)
                            <tr>
                                ...
                                <td class="d-flex">
                                    ...
                                    <a href="{{ route('management.users.destroy', $item->id) }}" class="btn btn-danger"
