...
class UserController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('content.management.users.index', compact('users'));
    }
    ...
    {
        $roles = Role::all();
        return view('content.management.users.createUser', compact('roles'));
    }
    ...
    public function store(Request $request)
    {
        try{
            ...
            return redirect()->route('content.management.users.createUser');
        }
    }
    ...
    public function edit(string $id)
    {
        $roles = Role::all();
        $user = User::find($id);
        return view('content.management.users.editUser', compact('roles', 'user'));
    }
    ...
    public function update(Request $request, string $id)
    {
        try{
            ...
            // catch error if users has duplicate email
            toastr()->error($e->getMessage());
            return redirect()->route('management.users.editUser');
        }
    }
